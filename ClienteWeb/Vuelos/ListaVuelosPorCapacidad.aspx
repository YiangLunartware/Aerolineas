<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="ListaVuelosPorCapacidad.aspx.cs" Inherits="ClienteASP.Vuelos.ListaVuelosPorCapacidad" %>

<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
</asp:Content>
<asp:Content ID="Content3" ContentPlaceHolderID="Titulo" runat="server">
    Listado de Vuelos por Capacidad entre fechas
</asp:Content>
        ...
        <ContentTemplate>
            <table>
                <tr>
                    <td>Capacidad: </td>
                    <td>
                        <asp:DropDownList ID="cboCapacidad" runat="server" Height="25px" Width="150px">
                        </asp:DropDownList>
                    </td>
                </tr>
                <tr>
